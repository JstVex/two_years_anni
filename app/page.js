...
export default function Home() {
  ...
  const url = ['/happianni', '/dates', '/mgcharcoal', '/masterpieces'];
  ...
  const handleLoveClick = () => {
    ...
    if (activeIndex === 0) {
      ...
      nextGroup = group4Ref.current;
    }
    else {
      currentGroup = group4Ref.current;
  ...
  return (
    <main className={styles.container}>
      <div className={styles.card_groups}>
        ...
        <div className={styles.card_group} ref={group4Ref} data-index="3" data-status="unknown">
          <div className={styles.little_card}>
